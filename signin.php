...
<html lang="en">
	...
	<body>
		<div id="container">
			...
			?>
			<section id="contentContainer" class="clearfix glass" style="margin-top: 30px; margin-bottom: 30px;">
				<div id="registration_wrapper" class="clearfix" style="background-color: #ffffff;">
					<div id="registration_form" style="width: 306px; padding-left: 40px; text-align: left;">
						...
						<form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post" id="regForm">
							...
							<p>&nbsp;</p>
							<input type="submit" class="required primary-button" name="submit" value="Sign In"  style="float:right;"/>
						</form>
					</div>
					<div id="form_right">
