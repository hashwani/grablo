<footer>
	<div class="line"></div>
		...
		<div id="footer_wrapper" style="width:960px; margin:auto;" class="clearfix">
			<div class="col" >
				<h3>About Grablo</h3>
		...
		<div id="footer_bottom" class="clearfix" style="width:960px; margin:auto; border-top:1px solid #CCCCCC;">
			<div id="copyright">Copyright &copy; <?php echo date('Y'); ?> <span><?php echo $SITE_TITLE; ?>.</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;All Rights Reserved.</div>
			<div id="contact">
...
<div style="display:none;">
	<div id="register" class="login">
		<form action="" id="regiter-form">
			<h2 style="text-align:left; color: #555555;">Enter Email Address To Register:</h2>
			<input type="text" id="register-email" />
			<a class="primary-button" href="javascript:sendMail()">Submit</a>
			<h4 class="error"> Please Enter Valid Email Address!</h4>
			<h3 style="text-align:left">Email Validation Link Will be Send To your email address.</h3>
		</form>
...
<div style="display:none;">
	<div id="login" class="login" style="margin: 0 10px;">
		<h1 style="font-family: 'Museo Sans', Helvetica, 'Helvetica Neue', Arial, sans-serif; font-size: 18px; margin: 5px 0; text-align: left; border-bottom: 1px solid #f0f0f0; padding-bottom: 3px; color: #555555;">Sign in:</h1>
