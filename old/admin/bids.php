<?php
	...
	$page = $table_name = "bids";
	$module_name = "bid";
	$max_rows = 20;
	$cols_to_show = array(
		"id" => array("ID", "15px"),
		"user_id" => array("User", "100px"),
		"product_id" => array("Product", "150px"),
		"bid" => array("Bid", "50px"),
				...
				<div class="content-module-main">
					<div class="clearfix">
						...
						<div style="margin-bottom: 5px; float: right;">
							<a class="fancybox_btn button round blue image-right ic-add text-upper" href="bid.php?action=add">Add <?php echo ucfirst($module_name); ?></a>
						</div>
					</div>
					<table>
						<thead>
			...
			for(var i = 0; i < data.length; i++) {
				container.append(
					'<tr>' +
						...
						'<td>' +
							'<a href="bid.php?action=update&id=' + data[i].id + '" class="fancybox_btn table-actions-button ic-table-edit"></a>' +
							'<a href="bid.php?action=delete&id=' + data[i].id + '" class="table-actions-button ic-table-delete"></a>' +
						'</td>' +
					'</tr>'
				);
			}
