...
<html lang="en">
	...
	<body>
		<div id="container">
			...
			?>
			<section style="width: 960px; padding: 6px; text-align: left; display: inline-block;" id="contentContainer" class="clearfix glass">
				<?php
					if(!empty($_POST["submit"])) {
						if(
							...
							echo '<div style="background-color: #ffffff;"><h2 style="color: #55ff55; margin: 0 10px 5px; font-size: 18px;">Congrtulations!!!</h2><p style="margin-left: 10px;">You have been successfully registered with ' . $SITE_TITLE . '.Click here to login <br /><br /><br /><br /></div>';
						} else {
							echo '<div style="background-color: #ffffff;"><h2 style="color: #ff5555; margin: 0 10px 5px; font-size: 18px;">ERROR Uploading Profile Pic</h2><p style="margin-left: 10px;">Profile photo is not a valid image or an error occured while uploading. Try again.<br /><br /><br /><br /></div>';
						}
					} else {
						if(isset($_GET['id']) && $_GET['id'] != '') {
							...
							if(count($vQ) > 0) {
					?>			<div id="registration_wrapper" class="clearfix" style="text-align: left; background-color: #ffffff;">
									<div id="registration_form" style="padding-left: 50px; width: 420px;">
										...
										<form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post" id="regForm" enctype="multipart/form-data">
											<h2 style="margin-top: 5px;">You Email Address: <span style="color: green; font-weight: bold;"><?php echo $vQ[0]["email_address"]; ?></span>
									...
									<div id="form_right" style="width: 410px;">
										<h1>Already have a <?php echo $SITE_TITLE; ?> account?</h1>
										<p style="font-size: 1.2em; margin-top: 5px;">Well then, you're in the wrong place. <a>Sign in</a>.</p>
									</div>
				...
				<?php
								...
								echo '<div style="background-color: #ffffff;"><h4 style="font-size: 24px;width:500px;margin: 10px auto;padding: 20px 15px;line-height: 2;"> oops... <br> <span style="color: red;font-size: 16px;">sorry !  we can\'t open your requeted url </span></h4></div>';
							}
						} else {
							echo '<div style="background-color: #ffffff;"><h4 style="font-size: 24px;width:500px;margin: 10px auto;padding: 20px 15px;line-height: 2;"> oops... <br> <span style="color: red;font-size: 16px;">sorry !  we can\'t open your requeted url </span></h4></div>';
						}
