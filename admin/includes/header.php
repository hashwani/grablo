	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width cf">
			...
			<ul id="tabs" class="fl">
				...
				<li><a href="adz.php" class="dashboard-tab <?php echo ($page == "adz" ? "active-tab" : ""); ?>">Adz</a></li>
				<li><a href="coupons.php" class="dashboard-tab <?php echo ($page == "coupons" ? "active-tab" : ""); ?>">Coupons</a></li>
				<li><a href="winners.php" class="dashboard-tab <?php echo ($page == "winners" ? "active-tab" : ""); ?>">Winners</a></li>
